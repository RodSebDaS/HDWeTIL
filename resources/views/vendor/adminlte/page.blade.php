...
@section('adminlte_css')
    ...
    <style>
        ...
        *{
        ...
        .icon1{
            transform: translate(-6px, -90px) scale(0);
        }
        ...
        .icon4{
            transform: translate(-104px, -350px) scale(0);
        }

        .icon5{
            transform: translate(-110px, -370px) scale(0);
        }

        .icon6{
            transform: translate(-102px, -40px) scale(0);
        }
        ...
        .container-icons:hover .icon5{
            transform: translate(-15px, -300px) scale(1);
        }

        .container-icons:hover .icon6{
