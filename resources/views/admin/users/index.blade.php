                        ...
                        extend: 'print',
                            ...
                            title: function() {
                                ...
                                if(filtro !== undefined && filtro !== '{}' ){
                                    return filtro.length || searchString.length? "Listado de Usuarios " + "Filtrado por: " + searchString + consulta : "Listado de Usuarios"
                                }
                    ...
                    },
                    {
                        extend: 'excelHtml5',
                            ...
                            title: function() {
                                ...
                                filtro =  (JSON.stringify(dfiltro, null,''));
                                if(filtro !== undefined && filtro !== '{}' ){
                                    return filtro.length || searchString.length? "Listado de Usuarios" + "Filtrado por: " + searchString + filtro : "Listado de Usuarios"
                                }
                                return searchString.length? "Listado de Usuarios Filtrado por: " + searchString : "Listado de Usuarios"
                            },
                            exportOptions: {
