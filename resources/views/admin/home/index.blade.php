                    ...
                    extend: 'print',
                            ...
                            title: function() {
                                ...
                                if(filtro !== undefined && filtro !== '{}' ){
                                    return filtro.length || searchString.length? "Listado de " + "Filtrado por: " + searchString + consulta : "Listado de "
                                }
                                return searchString.length? "Listado de "  + "Filtrado por: " + searchString : "Listado de "
                            },
