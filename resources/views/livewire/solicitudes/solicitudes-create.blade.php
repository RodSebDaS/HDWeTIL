<div>
    <form wire:submit.prevent="save" class="form-group" method="POST" action="/home/solicitudes"
        ...
        {{-- <div class="container-fluid"> --}}
            ...
            <hr>
            <div class="mt-2">
                <x-adminlte-button label="Enviar" type="button" theme="success" value="Enviar" class="btn btn-sm float-right"
