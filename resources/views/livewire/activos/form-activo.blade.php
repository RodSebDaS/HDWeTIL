    ...
    <div>
        ...
        @if (!isset($accion))
            ...
            <div class="row">
                ...
                {{-- Categoría --}}
                <x-adminlte-select2 wire:model.defer="categoria" name="categoria_id" label="Categoria(*):" label-class="text"
                ...
                <div wire:ignore>
                    {{-- Marca --}}
                        <x-adminlte-select2 wire:model.defer="marca" id="marca_id" name="marca_id" label="Marca(*):"
                  ...
                  {{-- Modelo --}}
                  @if (!is_null($modelos))
                      <x-adminlte-select2 wire:model.defer="modelo" name="modelo_id" label="Modelo(*):" label-class="text"
