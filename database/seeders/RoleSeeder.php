...
class RoleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // Servicios
        $permission = Permission::create(['name' => 'servicios.index', 'description' => 'Ver lista de servicios'])->syncRoles($role1, $role3, $role4, $role5);
        ...
        $permission = Permission::create(['name' => 'servicios.show', 'description' => 'Mostrar Servicio'])->syncRoles($role1, $role3, $role4, $role5);
        ...
        $permission = Permission::create(['name' => 'datatable.servicios', 'description' => 'Tabla Servicios'])->syncRoles($role1, $role3, $role4, $role5);
        ## Compontes
        //Historial
